System.register(['@angular/router', './app.login.component', './app.logout.component', './app.content.component', './app.signup.component', './app.profile.component', './guards/app.guard'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var router_1, app_login_component_1, app_logout_component_1, app_content_component_1, app_signup_component_1, app_profile_component_1, app_guard_1;
